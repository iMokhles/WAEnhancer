...
static BOOL unlimitedMedia = NO;
static BOOL unlimitedStatus = NO;
static BOOL unlimitedSubjects = NO;
static BOOL unlimitedPhotos = NO;
static BOOL mediaOptions = NO;
static BOOL shareStyle = NO;
static BOOL profilePic = NO;
static BOOL lastSeen = NO;
static BOOL readMark = NO;
static BOOL bcSelectAll = NO;
static BOOL textWALK = NO;
static BOOL openLink = NO;
static id disAll = nil;
static BOOL showKeyboard = NO;
static BOOL hideCamera = NO;
static BOOL newSettings = NO;
static BOOL activeWallapaperBOOL = NO;
