...
- (id)init {
    return [self initWithSharers:@[[CFSharer sendIMGVID], [CFSharer sendIMG], [CFSharer sendVID], [CFSharer sendLOCT], [CFSharer sendCNTC], [CFSharer sendLAST], [CFSharer sendEDIT], [CFSharer sendMUSIC]]];
}
