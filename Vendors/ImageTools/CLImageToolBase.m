...
+ (NSString*)defaultIconImagePath
{
    ...
    return [NSString stringWithFormat:@"/Library/Application Support/WAEnhancer/CLImageEditor.bundle/%@/%@/icon.png", NSStringFromClass([self class]), theme.toolIconColor];
}
